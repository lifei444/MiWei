...
- (void)loadSubViews {
    self.backImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, Screen_Width, cellH-8)];
    ...
    self.cityLabel = [[UILabel alloc] initWithFrame:CGRectMake(cityLabelX, cityLabelY, cityLabelWidth, cityLabelHeight)];
    ...
    self.weatherLabel = [[UILabel alloc] initWithFrame:CGRectMake(weatherLabelX, weatherLabelY, weatherLabelWidth, weatherLabelHeight)];
    ...
    self.pmLabel = [[UILabel alloc] initWithFrame:CGRectMake(pmLabelX, pmLabelY, pmLabellWidth, pmLabelHeight)];
    ...
    self.temperatureLabel = [[UILabel alloc] initWithFrame:CGRectMake(temperatureLabelX, temperatureLabelY, temperatureLabellWidth, temperatureLabelHeight)];
    ...
    self.outerLabel = [[UILabel alloc] initWithFrame:CGRectMake(outerLabelX, outerLabelY, outerLabellWidth, outerLabelHeight)];
